...
if(isset($_POST['btn']))
{
    ...
    if(move_uploaded_file($filetempname,$filestore))
    {
      ...
      {
        $sql="insert into basic_course(cid,name,image,description,overview,pdf_upload,duration,fees)
        values($cid,'$name','$filename','$dec','$overview','$pdfname','$duration',$fees)";
        if(mysqli_query($con,$sql))
        {
            echo '<script> alert("course data inserted")
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="" rows="4" name="desc"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Overview</label>
                      <textarea class="form-control" id="summernote" rows="4" name="overview"></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">PDF upload</label>
                      <input type="file" class="form-control" id="exampleInputName1" name="pdf">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Duration</label>
                      <input type="text" class="form-control" name="duration" placeholder="Email">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Fees</label>
                      <input type="text" class="form-control" name="fees" placeholder="Email">
                    </div>
