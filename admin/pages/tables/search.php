                  ...
                  <h4 class="card-title">Student Details</h4>
                    <table class="table table-striped">
                      ...
                      <?php 
                          ...
                          $search=$_POST['search'];
                          $column=$_POST['column'];
                          $sql="select * from student_details inner join registration on student_details.sid=registration.id inner join basic_course on student_details.course_name=basic_course.id where registration.$column like '%$search%'";
                      ...
                      <?php
                       ...
                       else
                       {
                          ...
                          window.location.href="student_details_table.php"</script>';
