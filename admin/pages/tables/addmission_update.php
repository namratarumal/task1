...
if(isset($_POST['btn']))
{
    ...
    $bid=$_POST['batchname'];
        ...
        $sql="update addmission set sid=$sid,batchid=$bid where id=$id";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Addmission Update</h4>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="batchname">
                        ...
                        <?php
                                ...
                                {
                                    ?>
                                    <option value="<?php echo $rw2[0];?>"> <?php echo $rw2[2];?>(<?php echo $rw2[1];?>)</option>
                                    <?php
                                }
                                ?>
                      </select>
