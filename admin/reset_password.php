...
if(isset($_POST['btn']))
{
   ...
   // $cmpass = password_hash($confirmpassword, PASSWORD_BCRYPT);

    
    if($newpassword==$confirmpassword)
    {
        $updatequery = "update registration set password='$newpassword',confirm_password='$confirmpassword' where email='$email'";
