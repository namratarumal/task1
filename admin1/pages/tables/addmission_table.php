        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Addmission Table</h4>
                  <div >
                       <a href="../forms/addmission_form.php">
                        <button style="color:white;background:black;width:20%;margin-left:10px;
                        height:40px;float:right;margin-bottom:30px;">Addmission Form</button></a>
                  </div>
                  <div >
                       <a href="export/addmission_export.php">
