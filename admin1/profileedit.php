...
if(isset($_POST['btn']))
{
    ...
    $cpass=$_POST['cpass'];
        ...
        if($pass==$cpass)
        {
        $updatequery="update admin_register set username='$usename',email='$email',password='$pass',confirm_password='$cpass' where email='$admin'";
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <?php
               $sql1="select * from admin_register where email='$admin'";
              ...
              <form class="pt-3" method="post">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="uname" value="<?php echo $rw1[1];?>" pattern="[a-z0-9]{1,15}">
                </div>
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" name="email" value="<?php echo $rw1[2];?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,4}$">
                </div>              
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" name="pass" value="<?php echo $rw1[3];?>" pattern="(?=.*\d)(?=.*[a-z]).{8,}">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" name="cpass" value="<?php echo $rw1[4];?>" pattern="(?=.*\d)(?=.*[a-z]).{8,}">
                </div>
